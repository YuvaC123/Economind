      ...
      <div className="max-w-3xl mx-auto px-6 py-16">
        ...
        <div className="space-y-8">
          ...
          <section>
            ...
            <p className="text-sm text-muted-foreground leading-relaxed">
              When you run a simulation, spending/saving/borrowing/investing amounts and
              confidence scores are generated by <code className="font-mono text-xs bg-muted px-1.5 py-0.5 rounded">generateMockSimulationResult()</code> —
              a function that returns a base value plus a random offset within a defined range.
              It is not a trained machine learning model and doesn't read your persona's actual
              income or the selected scenario's actual inflation rate to compute an answer. Treat
              individual simulation runs as illustrative, not reproducible or predictive.
            </p>
          </section>
